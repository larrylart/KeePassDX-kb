...
abstract class NestedSettingsFragment : PreferenceFragmentCompat() {
    ...
    enum class Screen {
        APPLICATION, FORM_FILLING, DEVICE_UNLOCK, APPEARANCE, OUTPUT_DEVICE, DATABASE, DATABASE_SECURITY, DATABASE_MASTER_KEY
    }
    ...
    companion object {
        ...
        fun newInstance(key: Screen)
            ...
            val fragment: NestedSettingsFragment = when (key) {
				...
				Screen.OUTPUT_DEVICE -> OutputDevicePreferenceFragment()
                Screen.DATABASE,
        ...
        fun retrieveTitle(resources: Resources, key: Screen): String {
            return when (key) {
				...
				Screen.OUTPUT_DEVICE -> resources.getString(R.string.menu_output_device_settings)				
